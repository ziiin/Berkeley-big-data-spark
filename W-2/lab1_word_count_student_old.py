...
# TODO: Replace <FILL IN> with appropriate code
wordCountsGrouped = wordsGrouped.map(lambda (w, wc): (w,sum(wc)))
...
def removePunctuation(text):
    ...
    """
    return ''.join(ch for ch in text.lower() if ch not in string.punctuation).strip()
...
print shakespeareWordsRDD.take(40)
